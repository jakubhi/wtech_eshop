...
<head>
    ...
    <title>Potvrdenie platby | E-Shop</title>
    <link href="{{ asset('css/output.css') }}" rel="stylesheet">
</head>

<body class="bg-white">
    <div class="flex flex-col min-h-screen 2 ">
      ...
      ">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="/cart">
                <img src="../images/cart.png" alt="Nákupný košík" class="h-10 pr-2 invert hover:opacity-80">
            </a>
        ...
        <main class="flex flex-col grow justify-center items-center">
            <div>
                <div class="flex justify-center w-fit ml-4 mr-4 p-4 sm:px-10 lg:px-40 bg-gray-400 mb-2 sm:text-xl md:text-2xl lg:text-xl font-bold rounded-lg text-center">Platba prebehla úspešne. Ďakujeme za Váš nákup!</div>
                <section class="flex justify-center">
                        <a href="/">
                            <button class="border rounded-xl border-gray-200 bg-gray-300
                                p-2 mt-6 mb-6 items-center text-center
